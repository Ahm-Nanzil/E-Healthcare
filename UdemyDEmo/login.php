...
echo '<h2>Login Form Example:</h2>';
	...
	echo '<form name="postLogin" action="login.php" method="post">';	
			echo '
				<P>User name: 
				<INPUT TYPE=text NAME=username value="" SIZE=22 MAXLENGTH=8></P>
				<P>Password: 
	...
	echo '<form name="postLoginHid" action="login.php" method="post">';	
			echo '
				<P>User name: 
